// Generated from the legacy HLBlowfishData.h (hex digits of pi, as per
// the Blowfish specification). Do not edit by hand.
...
namespace aw::crypto::detail {

inline constexpr std::array<std::uint32_t, 18> kParrayPi = {
...
inline constexpr std::array<std::uint32_t, 256> kSbox0 = {
...
inline constexpr std::array<std::uint32_t, 256> kSbox1 = {
...
inline constexpr std::array<std::uint32_t, 256> kSbox2 = {
...
inline constexpr std::array<std::uint32_t, 256> kSbox3 = {
