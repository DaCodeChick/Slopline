...
ConnectionBase::ConnectionBase(ConnectionConfig config, ConnectionEvents events)
    : config_(config), events_(std::move(events)) {}

ConnectionBase::ConnectionBase(ConnectionBase&&) noexcept = default;
auto ConnectionBase::operator=(ConnectionBase&&) noexcept -> ConnectionBase& = default;
